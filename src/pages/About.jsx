      ...
      <section className="relative py-32 bg-slate-100 dark:bg-brand-navy">
        ...
        <div className="relative z-10 px-4 mx-auto text-center max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
            <div className="p-10 border shadow-lg bg-white/50 dark:bg-white/5 backdrop-blur-xl rounded-3xl border-slate-200 dark:border-white/10 dark:shadow-none">
              <span className="block mb-2 text-4xl font-serif font-black text-brand-gold">10,000+</span>
              <p className="text-xs font-bold tracking-widest uppercase text-slate-500 dark:text-black">Sq. Ft. Showroom</p>
            </div>
            <div className="p-10 border shadow-lg bg-white/50 dark:bg-white/5 backdrop-blur-xl rounded-3xl border-slate-200 dark:border-white/10 dark:shadow-none">
              <span className="block mb-2 text-4xl font-serif font-black text-brand-red">15,000+</span>
              <p className="text-xs font-bold tracking-widest uppercase text-slate-500 dark:text-black">Products in Stock</p>
            </div>
            <div className="p-10 border shadow-lg bg-white/50 dark:bg-white/5 backdrop-blur-xl rounded-3xl border-slate-200 dark:border-white/10 dark:shadow-none">
              <span className="block mb-2 text-4xl font-serif font-black text-brand-navy dark:text-white">50+</span>
              <p className="text-xs font-bold tracking-widest uppercase text-slate-500 dark:text-black">Global Luxury Brands</p>
            </div>
          </div>
        </div>
      </section>
