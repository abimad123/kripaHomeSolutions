      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col lg:col-span-2" id="main-player">
          ...
          <div className="px-2 mt-8">
            <h3 className="mb-3 text-2xl md:text-3xl font-black leading-tight transition-colors font-serif text-brand-navy dark:text-white group-hover:text-brand-red">
              {currentVideo.title}
            </h3>
