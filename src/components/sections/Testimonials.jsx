        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {testimonials.map((item, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="relative p-8 pt-12 transition-all duration-300 border shadow-sm bg-slate-50 dark:bg-brand-surface rounded-[2.5rem] border-slate-100 dark:border-white/10 hover:shadow-2xl hover:shadow-slate-200 dark:hover:shadow-black/50 group"
            >
              <div className="absolute transition-colors duration-300 top-8 right-8 text-slate-200 dark:text-white/5 group-hover:text-brand-red/10">
